...
const WantLogin = () => {
  ...
  const loginfocus = useFocusable({
    focusKey: "login_focus",
    onEnterPress: () => navigate("/signin"),
    focusable: true,
    onFocus: () => {
      loginref.current?.focus();
    },
  });
  const cancelfocus = useFocusable({
    focusKey: "cancel_focus",
    ...
    <div ref={ref} className="want-div">
      <div className="want-btn">
        ...
        <div ref={loginfocus.ref}>
          <button
            ref={loginref}
            className={`want ${loginfocus.focused ? "focused" : ""}`}
          >
            Log in
          </button>
        </div>
        <div ref={cancelfocus.ref}>
          <button
            ref={cancelref}
            className={`notwant ${cancelfocus.focused ? "focused" : ""}`}
          >
            Cancel
          </button>
        </div>
