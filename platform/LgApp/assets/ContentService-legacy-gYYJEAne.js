...
(function () {
  ...
  System.register([], function (exports, module) {
    ...
    return {
      execute: function () {
        const API = {
          contentByGenre: genre => `/content/filters/${genre}?origin=enhance&origin=vcms&source=enhance&region=IN&maxParentalRatings=UA&language=en-US&platform=web`,
          ...
          contentDetails: id => `/content/${id}?type=movie&platform=web&schema=1.0.2&region=IN&maxParentalRatings=UA&language=en-US`
        };
        ...
        const factory = env => {
          ...
          const resolveBodyLength = /*#__PURE__*/function () {
            var _ref5 = _asyncToGenerator(function* (headers, body) {
        ...
        const fetchContentByGenre = exports("a", genre => __async(null, null, function* () {
          const res = yield APIService.get(API.contentByGenre(genre));
          return res.data.content;
        }));
        const fetchContentDetails = exports("f", id => __async(null, null, function* () {
          const res = yield APIService.get(API.contentDetails(id));
          return res.data;
        }));
      }
    };
